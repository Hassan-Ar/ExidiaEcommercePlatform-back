        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingAddress = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    BusinessHours = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    TaxId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    PaymentMethods = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    ShippingMethods = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Condition = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DynamicPriceRules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DynamicPriceRules_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DynamicPriceRules_ProductId",
                table: "DynamicPriceRules",
                column: "ProductId");
